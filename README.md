...
+ Added generic configuration settings for MKMTool that can be specified in the config.xml.
+ Added setting to choose the CSV separator to use when exporting files (currently used in View Inventory, Price External List and Download Buys).
