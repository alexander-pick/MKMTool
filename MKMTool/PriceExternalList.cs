...
namespace MKMTool
{
  ...
  {
    private readonly UpdatePriceSettings botSettings = new UpdatePriceSettings("LastSettingsPresetExtList", "Settings of Price External List");
    private readonly MKMBot bot = new MKMBot();
    private readonly List<MKMMetaCard> importedAll = new List<MKMMetaCard>();
    private readonly List<MKMMetaCard> importedValidOnly = new List<MKMMetaCard>();
    ...
    private void priceExternalList_Shown(object sender, EventArgs e)
    {
      ...
      foreach (var Lang in LanguagesNames)
      {
