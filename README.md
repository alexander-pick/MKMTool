...
+ Added default Rarity option to Price External List: rarity can be relevant in appraisal. Default value is set to "Rare" so that the "Min rare price" setting is used when appraising an article with unknown rarity.
...
+ For rarity, use Rare or Mythic if you want the "Minimum rare price" setting to be used when appraising.
